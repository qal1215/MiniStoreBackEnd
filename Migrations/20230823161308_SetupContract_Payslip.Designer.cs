...
namespace MiniStore.Migrations
{
    ...
    [Migration("20230823161308_SetupContract_Payslip")]
    partial class SetupContract_Payslip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MiniStore.Models.Payslip", b =>
                {
                    ...
                    b.Property<decimal>("TotalWorkLate")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MiniStore.Models.Payslip", b =>
                {
                    b.HasOne("MiniStore.Models.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("MiniStore.Models.Payslip", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
